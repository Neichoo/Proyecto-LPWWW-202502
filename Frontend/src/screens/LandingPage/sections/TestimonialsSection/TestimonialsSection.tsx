...
export const TestimonialsSection = (): JSX.Element => {
  return (
    <section className="w-full flex flex-col gap-8 py-12">
      <h2 className="text-center [font-family:'Roboto',Helvetica] font-semibold text-black text-5xl tracking-[-0.96px] leading-normal translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:0ms]">
